...
east_province_area_two.add("Dreepy (Violet)_Dragon_Ghost", "5")
...
glaseado_mountain.add("Misdreavus (Violet)_Ghost", "0/0/0/60")
...
glaseado_mountain.add("Dreepy (Violet)_Dragon_Ghost", "15")
...
glaseado_mountain.add("Dreepy (Violet)_Dragon_Ghost", "5")
...
glaseado_mountain.add("Clauncher (Violet)_Water", "60")
glaseado_mountain.add("Clawitzer (Violet)_Water", "20")
glaseado_mountain.add("Bergmite_Ice", "60")
glaseado_mountain.add("Avalugg_Ice", "20")
glaseado_mountain.add("Barraskewda_Water", "20")
...
glaseado_mountain.add("Bagon (Violet)_Dragon", "10")
...
pokemon_league.add("Fidough_Fairy","50")
...
socarrat_trail.add("Sawsbuck_Normal_Grass", "50")
...
south_province_area_four.add("Charcadet_Fire", "1")
south_province_area_four.add("Flittle_Psychic", "60")
...
south_province_area_four.add("Dreepy (Violet)_Dragon_Ghost", "15")
south_province_area_four.add("Psyduck_Water", "60")
...
south_province_area_six.add("Whiscash_Water_Ground", "10")
south_province_area_six.add("Mismagius (Violet)_Ghost", "0/0/0/3")
south_province_area_five.add("Basculin (Red-Striped)_Water", "60")
south_province_area_five.add("Basculin (Blue-Striped)_Water", "60")
south_province_area_six.add("Drednaw_Water_Rock", "10")
south_province_area_six.add("Dreepy (Violet)_Dragon_Ghost", "15")
south_province_area_six.add("Clodsire_Poison_Ground", "30")
south_province_area_six.add("Psyduck_Water", "60")
south_province_area_six.add("Golduck_Water", "20")
south_province_area_six.add("Magikarp_Water", "20")
south_province_area_six.add("Vaporeon_Water", "1")
...
west_province_area_two.add("Azumarill_Water_Fairy", "30")
...
west_province_area_three.add("Azumarill_Water_Fairy", "30")
west_province_area_three.add("Misdreavus_Ghost", "0/0/0/60")
