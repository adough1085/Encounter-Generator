...
const DistributionForm = ({ distribution }) => {
  ...
  const handleSubmit = (event) => {
    ...
    distribution(game, area, time, pkmnType, power, dupes);
  };
  ...
  return (
    <form className="form-grid" onSubmit={handleSubmit}>
      <div className="form-group">
        ...
        <select value={game} onChange={handleChangeGame} id="gameVersion">
      ...
      <div className="form-group">
        ...
        <select value={area} onChange={handleChangeArea} id="area">
      ...
      <div className="form-group">
        ...
        <select value={time} onChange={handleChangeTime} id="time">
      ...
      <div className="form-group">
        <label htmlFor="encounterPowerType">Encounter Power Type</label>
        <select value={pkmnType} onChange={handleChangePkmnType} id="encounterPowerType">
      ...
      <div className="form-group">
        <label htmlFor="encounterPowerLevel">Encounter Power Level</label>
        <select value={power} onChange={handleChangePower} id="encounterPowerLevel">
      ...
      <div className="form-group">
        <label htmlFor="dupesClause">Use Dupes Clause</label>
        <select value={dupes} onChange={handleChangeDupes} id="dupesClause">
          <option value="No">No</option>
          <option value="Yes">Yes</option>
        </select>
      </div>
        <button className="span-all" type="submit">Generate Distribution</button>
    </form>
  );
};
